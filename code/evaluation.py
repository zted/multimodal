...
if __name__ == "__main__":
    ...
    measure = 'dispersion'
    visual_vecs_type = 'maxpool' #for the VISUAL embeddings
    n_cutoffs = 10
    dataset = 'men'
    #dataset = 'wordsim353'
    ...
    print('visual_only=' ,[round(el, 2) for el in perf_visual_only ])
    print('mapping_method=' , [round(el, 2) for el in perf_map_method ])
    print('text_only=', round(perf_text_only, 2) )
    print('random_method=', round(perf_random, 2) )
    print('visual_only_onlymap=', round(perf_visual_only_onlymap, 2))
