...
#PIPELINE: given a matrix with visual representations (first column is word), 1. we build first a matrix with the word embedding vectors
# 2. then a concatenated vector (visual + text)
